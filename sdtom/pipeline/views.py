...
from sdtom.pipeline.jobs import update_datums_from_mars, update_datums_from_alerce
...
class UpdateDatumsFromAlerceView(View):
    def get(self, request, *args, **kwargs):
        target = get_object_or_404(Target, pk=request.GET.get("target_id"))
...
class ClassificationView(View):
    ...
    async def get(self, request, *args, **kwargs):
        ...
        graph = offline.plot(fig, output_type="div", show_link=False)
