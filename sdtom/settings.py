...
Generated by ./manage.py tom_setup on Aug. 4, 2021, 4:30 p.m.
...
SECRET_KEY = "0rm1glx5go9^k6mtrzai&amp;$lpc$%9&amp;*tq$4(j)fa3p9)mt)#vyc"
...
WSGI_APPLICATION = "sdtom.wsgi.application"
...
TOM_ALERT_CLASSES = [
    ...
    "sdtom.alerts.lasair_iris.LasairIrisBroker",
]
...
BROKERS = {
    ...
    "LASAIRIRIS": {"api_key": os.getenv("LASAIR_API_KEY")},
}
